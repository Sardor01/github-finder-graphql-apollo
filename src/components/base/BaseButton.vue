...
const btnVariant = computed<string>(() => {
  switch (props.variant) {
    case 'custom':
      return ''
    case 'gray':
      return 'bg-gray-700 text-white ring-gray-700/30 hover:bg-gray-600'
    case 'red':
      return 'bg-red-500 text-white ring-red-500/30 hover:bg-red-500/90'
    default:
      return 'bg-transparent text-gray-800 ring-blue-400/30'
  }
})
</script>
...
<template>
  ...
  >
    <svg
      ...
      viewBox="0 0 100 101"
      aria-hidden="true"
      class="mr-2.5 h-5 w-5 animate-spin fill-transparent text-current"
    >
      <path
